...
export default function Home() {
  ...
  <blockquote class="text-center lg:mx-auto lg:w-3/5">
    <svg class="mx-auto w-20 h-auto sm:w-28 text-gray-800 dark:text-black-200" width="106" height="36" viewBox="0 0 106 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mt-6 lg:mt-10">
      <p class="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium text-gray-800">
        <svg class="absolute top-0 start-0 transform -translate-x-8 -translate-y-8 size-16 text-gray-200 sm:h-24 sm:w-24 dark:text-black-700" width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <span class="relative z-10 italic text-gray-800 dark:text-black-200">こちらが私のポートフォリオサイトです。私のクリエイティブな旅の軌跡をお楽しみください。</span>
      </p>
    </div>

    <footer class="mt-6">
      <div class="font-semibold text-gray-800 dark:text-black-200">Keishu</div>
      <div class="text-sm text-gray-500 dark:text-black-500">Student | Here</div>
    </footer>
  </blockquote>
